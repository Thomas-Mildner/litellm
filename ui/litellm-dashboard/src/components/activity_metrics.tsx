    ...
    <div className="space-y-2">
      ...
      <Grid numItems={4} className="gap-4">
        ...
        <Card>
          ...
          <Title>{formatCurrency(metrics.total_spend.toFixed(2))}</Title>
          <Text>
            {formatCurrency(
              (metrics.total_spend / metrics.total_successful_requests).toFixed(
                3
              )
            )}
      ...
      <Grid numItems={2} className="gap-4">
        ...
        <Card>
          ...
          <BarChart
            ...
            colors={["green"]}
            valueFormatter={(value: number) => formatCurrency(value.toFixed(2))}
          />
        </Card>
    ...
    <div className="space-y-8">
      ...
      <div className="border rounded-lg p-4">
        ...
        <Grid numItems={4} className="gap-4 mb-4">
          ...
          <Card>
            <Text>Total Spend</Text>
            <Title>{formatCurrency(totalMetrics.total_spend.toFixed(2))}</Title>
          </Card>
        </Grid>
            ...
            header={
              <div className="flex justify-between items-center w-full">
                ...
                <div className="flex space-x-4 text-sm text-gray-500">
                  <span>
                    {formatCurrency(
                      modelMetrics[modelName].total_spend.toFixed(2)
                    )}
                  </span>
                  <span>
